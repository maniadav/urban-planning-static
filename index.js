...
(function () {
  ...
  // Add debug click listener to get yaw and pitch coordinates
  ...
  // testing new method for stability
  function createInfoHotspotElement(hotspot) {
    // Create wrapper element to hold icon and tooltip.
    var wrapper = document.createElement("div");
    wrapper.classList.add("hotspot");
    wrapper.classList.add("image-info-hotspot");

    // Create image element.
    var icon = document.createElement("img");

    icon.src = hotspot.customIconSrc || "img/info.png";
    icon.classList.add("link-hotspot-icon");
  ...
  function createInfoHotspotElement2(hotspot) {
    // Create wrapper element to hold icon and tooltip.
    var wrapper = document.createElement("div");
    wrapper.classList.add("hotspot");
    wrapper.classList.add("info-hotspot");

    // Add elevated class if specified
    if (hotspot.elevated) {
      wrapper.classList.add("elevated-hotspot");
    }
